...
public class ReceiveRefundMoenyActivity extends ActivityBaseHeader implements OnPullListener,
    ...
    private ReceiveRefundAdapter receiveRefundAdapter;
    ...
    private void initView() {
        ...
        receiveRefundAdapter.setOnCheckedkType(this);
        ...
        receiveRefundAdapter = new ReceiveRefundAdapter(this, mList);
        receiveRefundAdapter.notifyDataSetChanged();
        payment_list.setAdapter(receiveRefundAdapter);
