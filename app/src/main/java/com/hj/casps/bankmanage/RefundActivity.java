...
public class RefundActivity extends ActivityBaseHeader implements OnPullListener,
    ...
    private TextView offline_payment_reset;
    ...
    private void initView() {
        ...
        offline_payment_reset.setOnClickListener(this);

        offline_payment_btn = (TextView) findViewById(R.id.offline_payment_btn);
        offline_payment_btn.setText(getText(R.string.head_retreat_money_verify_title));
        offline_payment_btn.setOnClickListener(this);
        offline_payment_btn.setBackgroundResource(R.color.reset_bg);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_operation_explain:
                //操作说明
                break;
            case R.id.offline_payment_reset:
                //重置
                break;
        }
    }
    ...
    public void showBillsDialog(final int bills) {
        ...
        myDialog.setYesOnclickListener(getString(R.string.True), new MyDialog.onYesOnclickListener() {
            ...
            public void onYesClick() {
                myDialog.dismiss();
                new MyToast(RefundActivity.this, "退款成功" + bills + "条");
                deleteBills();
            }
        });
