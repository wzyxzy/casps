...
import com.hj.casps.adapter.payadapter.ViewHolderCommodity;
import com.hj.casps.adapter.payadapter.ViewHolderFather;
...
public class BillsDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<PayMnetInfo> listOne;
    private List<PayMnetInfo.CommodityIndo> listTwo;
    private List<String> listTitle;
    private List<Integer> types = new ArrayList<>();
    private Map<Integer, Integer> mPositions = new HashMap<>();

    public BillsDetailsAdapter(Context context, List<PayMnetInfo> listOne,
