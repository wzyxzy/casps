...
public class ExpressAdapte extends BaseAdapter {
    private List<ExpressInfoEntity> mList;
    ...
    public ExpressAdapte(List<ExpressInfoEntity> mList, Context context) {
        this.mList = mList;
    ...
    public void refreshList(List<ExpressInfoEntity> list) {
        this.mList = list;
