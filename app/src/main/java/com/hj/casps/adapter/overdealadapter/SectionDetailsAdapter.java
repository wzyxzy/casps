...
public class SectionDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SectionEntity> listOne;
    private List<SectionEntity.OrderList> listTwo;
    private List<String> listTitle;
    private List<Integer> types = new ArrayList<>();
    private Map<Integer, Integer> mPositions = new HashMap<>();

    public SectionDetailsAdapter(Context context, List<SectionEntity> listOne,
                                 List<SectionEntity.OrderList> listTwo,
