...
public class ViewHolderTypeOne extends TypeAbstractViewHolder<SectionEntity> {
    ...
    @Override
    public void bindViewHolder(SectionEntity sectionEntity, final int postion) {
        layout_0_tv_content.setText(sectionEntity.getSettleCode());
        layout_1_tv_content.setText(sectionEntity.getMmbpayName());
        layout_2_tv_content.setText(sectionEntity.getMmbgetName());
        layout_3_tv_content.setText(sectionEntity.getSettleMoney() + "");
        layout_4_tv_content.setText(sectionEntity.getCtrTime());
        layout_5_tv_content.setText(sectionEntity.getCtrMoney() + "");
        setStatusValue(sectionEntity.getStatus());
        setStatusSingnValue(sectionEntity.getStatusSingn());
        setStatusRegistValue(sectionEntity.getStatusRegist());
    }
